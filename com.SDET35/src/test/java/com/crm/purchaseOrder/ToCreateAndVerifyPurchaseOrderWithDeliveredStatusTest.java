...
public class ToCreateAndVerifyPurchaseOrderWithDeliveredStatusTest extends BaseClass {
	...
	public void createAndVerifyPurchaseOrderWithDeliveredStatusTest() throws EncryptedDocumentException, IOException {
		...
		String deliveredStatus = excel.getValueFromExcel("Purchase order", 3, 3);
		...
		createNewPurchaseOrder.status(deliveredStatus);
