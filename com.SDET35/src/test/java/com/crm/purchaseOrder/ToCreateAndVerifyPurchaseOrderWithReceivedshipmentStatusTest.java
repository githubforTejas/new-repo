...
public class ToCreateAndVerifyPurchaseOrderWithReceivedshipmentStatusTest extends BaseClass{
	@Test(groups="regressionTest",retryAnalyzer = com.crm.genericutility.RetryAnalyserImp.class)
	public void createAndVerifyPurchaseOrderWithReceivedshipmentStatusTest() throws EncryptedDocumentException, IOException {
		...
		String receivedShipment = excel.getValueFromExcel("Purchase order", 4, 3);
		...
		//verify whether the Vendor is created or not
		...
		createNewPurchaseOrder.status(receivedShipment);
		createNewPurchaseOrder.AssignedToRadioBtn();
		createNewPurchaseOrder.AssignedToDropDown(assignedToSupportGroup);
